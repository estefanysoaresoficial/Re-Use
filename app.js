...
function htmlCardEmpresa(emp){
  ...
  return (
    '<article class="card-empresa">' +
      '<div class="card-empresa__capa" style="background:'+emp.cor+'">'+emp.emoji+
...
function htmlCardProduto(p, opts){
  ...
  return (
    '<article class="card-produto" data-abrir-produto="'+p.id+'">' +
      '<div class="card-produto__capa">'+p.emoji+
  ...
  '<section class="secao">' +
    '<div class="wrap">' +
      ...
      '<div class="perfil-empresa">' +
        '<div class="perfil-empresa__capa" style="background:'+(emp.cor||'var(--verde)')+'">'+emp.emoji+'</div>' +
...
function paginaProduto(id){
  ...
  '<section class="secao">' +
    '<div class="wrap">' +
      ...
      '<div class="detalhe">' +
        '<div>' +
          '<div class="detalhe__foto">'+p.emoji+'</div>' +
